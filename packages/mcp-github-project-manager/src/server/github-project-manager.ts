...
const GITHUB_TOKEN =
    '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';
...
export async function startGitHubProjectManagerServer(token?: string) {
    ...
    const githubToken = token || GITHUB_TOKEN;
    ...
    server.tool(
        ...
        'List issues in a GitHub repository with filtering options',
        {
            ...
            mentioned: z
                .string()
                .optional()
                .describe('Filter by mentioned user'),
            milestone: z
                .string()
                .optional()
